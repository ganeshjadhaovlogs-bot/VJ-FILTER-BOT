...
API_ID = int(environ.get('API_ID', '38606607'))
API_HASH = environ.get('API_HASH', 'API_HASH:898294a8e1369b2728a64d7de9911188')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1892022206').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1892022206').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Ganesh6081:Ganesh6081@ganesh6081.lrka5nt.mongodb.net/?appName=Ganesh6081")   # IF Multiple Database Is False Then Fill Only This Database Url.
